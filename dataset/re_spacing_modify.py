...
new_path = './0123456_spacing_same_modify_half2'
                    ...
                    for i_dirs3 in sorted(dirs3):  # case_00000
                        ...
                        for root4, dirs4, files4 in os.walk(os.path.join(root3, i_dirs3)):
                            for i_files4 in sorted(files4):
                                ...
                                # if imageITK.GetSpacing() == (1.0,1.0,1.0):
                                #     spacing_missing_data.append(img_path)
                                #     print(imageITK.GetSpacing())
                                # continue

                                task_id = int(i_dirs1[0])
                                target_spacing = np.array(spacing[task_id])[[2, 1, 0]]
                                ...
                                print(saveITK.GetSize(), saveITK.GetSpacing())
